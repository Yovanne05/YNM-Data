...
INSERT INTO Entrepot_Netflix.Visionnage (idUtilisateur, idTitre, idDate, idGenre, idLangueDisponible, dureeVisionnage, nombreVues) VALUES
-- Utilisateur 1 (Abonnement Premium) - surtout des films d'action
(1, 1, 1, 1, 1, 209, 1),   -- The Irishman (vu en entier)
(1, 6, 1, 1, 2, 117, 2),    -- Extraction (vu 2 fois)
(1, 24, 3, 1, 1, 45, 5),    -- The Witcher (5 épisodes)

-- Utilisateur 2 (Standard) - préfère les comédies
(2, 5, 2, 2, 3, 138, 1),    -- Don't Look Up
(2, 17, 2, 2, 1, 90, 1),     -- Buster Scruggs (partiellement)
(2, 37, 4, 2, 2, 30, 3),     -- Sex Education (3 épisodes)

-- Utilisateur 3 (Basic) - fan de séries
(3, 21, 5, 3, 1, 300, 10),  -- Stranger Things (10 épisodes)
(3, 31, 5, 1, 3, 480, 1),   -- Squid Game (toute la saison)
(3, 45, 6, 5, 2, 45, 1),     -- Wednesday (1 épisode)

-- Utilisateur 4 (Premium) - diversifié
(4, 3, 7, 3, 4, 135, 1),     -- Roma
(4, 15, 7, 8, 1, 115, 2),    -- The Sea Beast (2 fois)
(4, 30, 8, 1, 2, 200, 4),    -- Money Heist (4 épisodes)

-- Utilisateur 5 (Standard) - horreur/thriller
(5, 11, 9, 5, 5, 124, 1),    -- Bird Box
(5, 39, 9, 5, 1, 45, 3),     -- Haunting of Hill House
(5, 7, 10, 1, 3, 129, 1),    -- The Gray Man

-- Utilisateur 6 (Basic) - famille
(6, 14, 11, 8, 1, 113, 3),   -- Mitchells vs Machines (3x)
(6, 16, 11, 8, 2, 96, 5),    -- Klaus (5x)
(6, 8, 12, 2, 1, 123, 1),    -- Enola Holmes

-- Utilisateur 7 (Résilié) - peu d'activité
(7, 2, 13, 3, 2, 60, 1),     -- Marriage Story (partiel)
(7, 25, 13, 6, 1, 45, 1);    -- Bridgerton (1 épisode)
